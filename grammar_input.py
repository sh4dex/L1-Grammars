...
class GrammarInputWindow:
    ...
    def setup_ui(self):
        ...
        add_btn = ttk.Button(non_terminal_frame, text="Add Non-Terminal Symbol",
        ...
        add_btn = ttk.Button(terminal_frame, text="Add Terminal Symbol",
        ...
        self.axiomatic_entry = ttk.Entry(axiomatic_frame)
        ...
        add_btn = ttk.Button(productions_frame, text="Add New Production",
        ...
        self.submit_btn = ttk.Button(submit_frame, text="Add Grammar", width=20, command=self.on_submit)
    ...
    def add_production_entry(self, parent):
        ...
        left_entry = ttk.Entry(frame, width=10)
        ...
        right_entry = ttk.Entry(frame, width=30)
